...
-- Reset sequences
ALTER TABLE catalog_services ALTER COLUMN id RESTART WITH 1;
ALTER TABLE clients ALTER COLUMN id RESTART WITH 1;
ALTER TABLE vehicles ALTER COLUMN id RESTART WITH 1;
ALTER TABLE service_orders ALTER COLUMN id RESTART WITH 1;
...
-- Veículos
INSERT INTO vehicles (id, owner_id, client_id, license_plate, plate, brand, model, vehicle_year, vin, color, fuel_type, created_at, updated_at)
VALUES (1, 1, 1, 'ABC1234', 'ABC1234', 'Toyota', 'Corolla', 2020, 'VIN123456789', 'Prata', 'GASOLINE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

INSERT INTO vehicles (id, owner_id, client_id, license_plate, plate, brand, model, vehicle_year, vin, color, fuel_type, created_at, updated_at)
VALUES (2, 2, 2, 'DEF5678', 'DEF5678', 'Honda', 'Civic', 2021, 'VIN987654321', 'Preto', 'GASOLINE', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
INSERT INTO service_orders (id, client_id, vehicle_id, description, estimated_amount, status, created_at, updated_at, approved_at)
...
INSERT INTO services (id, service_order_id, catalog_service_id, price, status, created_at, started_at, approved_at, completed_at, updated_at)
...
-- Reset sequences
ALTER TABLE catalog_services ALTER COLUMN id RESTART WITH 3;
ALTER TABLE clients ALTER COLUMN id RESTART WITH 3;
ALTER TABLE vehicles ALTER COLUMN id RESTART WITH 3;
ALTER TABLE service_orders ALTER COLUMN id RESTART WITH 3;
ALTER TABLE services ALTER COLUMN id RESTART WITH 3;
