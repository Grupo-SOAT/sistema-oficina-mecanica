...
3. Rodar o comando `docker-compose up -d` e aguardar o download das imagens e criação dos containeres. Essa etapa garante que o banco de dados seja preenchido com valores default para agilizar possíveis testes locais.
